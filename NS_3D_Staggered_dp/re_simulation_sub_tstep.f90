    ...
    logical, parameter :: using_Ustar=.true., TOffset=.true.
    real(8), parameter :: noise=0;
    real(8), dimension (:,:), allocatable :: err_vel, rms_vel, err_vel_base, rms_vel_base
    logical, parameter :: comp_base=.true., LU_poisson=(.false. .and. nxp*nyp*nzp<=34**3), FFT_poisson=(pbc_x==1 .and. pbc_y==1 .and. pbc_z==1), DCT_poisson=(pbc_x/=1 .and. pbc_y/=1 .and. pbc_z/=1)
