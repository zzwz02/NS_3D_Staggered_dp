    ...
    ! public procedures
    procedure, pass, public :: output_filename=> set_output_filename
    ...
    write(unit=this%file_unit, fmt='(a)') 'set term ' // gnuplot_term_type // &
        ' size ' // gnuplot_term_size // ' enhanced font "' // &
        gnuplot_term_font // '"'   ! library name and version
    
    !write(unit=this%file_unit, fmt='(a)') 'set size square'   ! library name and version
    write(unit=this%file_unit, fmt='(a)') 'set view equal xyz'   ! library name and version
    
    if ( gnuplot_term_type /= 'wxt' .and. index(this%output_name, gnuplot_term_type) == 0 ) then
        this%output_name = trim(this%output_name) // '.' // trim(gnuplot_term_type)
    end if
    write(unit=this%file_unit, fmt='(a)') 'set output "' // trim(this%output_name) // '"'   ! output name
    ...
    call execute_command_line ('"C:\Program Files\gnuplot\bin\gnuplot.exe" -persist ' // this%txtfilename, wait=.false.)  !   Now plot the results

    end subroutine finalize_plot

    subroutine draw_now(this)
    !..............................................................................
    ! To finalize multiplot.
    !..............................................................................
    class(gpf) :: this
    ...
    subroutine set_output_filename(this, string)
    !..............................................................................
    !Set the zlabel
    !..............................................................................
    class(gpf):: this
