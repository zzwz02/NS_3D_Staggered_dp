...
crit=1.004;
err_u_max(1)=max(err_1.rel_err_u(10:end));
err_u_max(2)=max(err_2.rel_err_u(10:end));
err_u_max(3)=max(err_3.rel_err_u(10:end));
err_u_max(4)=max(err_4.rel_err_u(10:end));
err_u_max(5)=max(err_5.rel_err_u(10:end));
...
err_u_max(1)=max(err_1.rel_err_v(10:end));
err_u_max(2)=max(err_2.rel_err_v(10:end));
err_u_max(3)=max(err_3.rel_err_v(10:end));
err_u_max(4)=max(err_4.rel_err_v(10:end));
err_u_max(5)=max(err_5.rel_err_v(10:end));
polyfit(log(dt),log(err_u_max),1)
...
err_u_max(1)=max(err_1.rel_err_w(10:end));
err_u_max(2)=max(err_2.rel_err_w(10:end));
err_u_max(3)=max(err_3.rel_err_w(10:end));
err_u_max(4)=max(err_4.rel_err_w(10:end));
err_u_max(5)=max(err_5.rel_err_w(10:end));
polyfit(log(dt),log(err_u_max),1)
...
err_u_max(1)=max(err_1.rel_err_dp(10:end));
err_u_max(2)=max(err_2.rel_err_dp(10:end));
err_u_max(3)=max(err_3.rel_err_dp(10:end));
err_u_max(4)=max(err_4.rel_err_dp(10:end));
err_u_max(5)=max(err_5.rel_err_dp(10:end));
polyfit(log(dt),log(err_u_max),1)

figure(2)
loglog(dt,err_u_max,'+','Color',pcolor)
hold on;
temp1=log10(dt); temp2=log10(err_u_max);
