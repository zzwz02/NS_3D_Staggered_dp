...
for T=1:20
    for idx=1:length(dt)
        ...
        err_u_star_in=u_star(2:end-1,2:end-1,2:end-1)-u_star_sub(2:end-1,2:end-1,2:end-1);
        err_RHS_in=RHS(2:end-1,2:end-1,2:end-1)-RHS_sub(2:end-1,2:end-1,2:end-1);
        err_dp_in=dp(2:end-1,2:end-1,2:end-1)-dp_sub(2:end-1,2:end-1,2:end-1);
        err_p_in=p(2:end-1,2:end-1,2:end-1)-p_sub(2:end-1,2:end-1,2:end-1);
        err_u_in=u(2:end-1,2:end-1,2:end-1)-u_sub(2:end-1,2:end-1,2:end-1);
        
        temp1=u_star; temp2=u_star_sub; temp1(2:end-1,2:end-1,2:end-1)=nan; temp2(2:end-1,2:end-1,2:end-1)=nan;
        err_u_star_bc=temp1-temp2;
        temp1=RHS; temp2=RHS_sub; temp1(2:end-1,2:end-1,2:end-1)=nan; temp2(2:end-1,2:end-1,2:end-1)=nan;
        err_RHS_bc=temp1-temp2;
        temp1=dp; temp2=dp_sub; temp1(2:end-1,2:end-1,2:end-1)=nan; temp2(2:end-1,2:end-1,2:end-1)=nan;
        err_dp_bc=temp1-temp2;
        temp1=p; temp2=p_sub; temp1(2:end-1,2:end-1,2:end-1)=nan; temp2(2:end-1,2:end-1,2:end-1)=nan;
        err_p_bc=temp1-temp2;
        temp1=u; temp2=u_sub; temp1(2:end-1,2:end-1,2:end-1)=nan; temp2(2:end-1,2:end-1,2:end-1)=nan;
        err_u_bc=temp1-temp2;
