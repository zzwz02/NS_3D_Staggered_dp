...
err_1 = import_err_file('../err_file/spline/base_err_vel_AB2_2.E-3_N_Ustar_TOffset.txt');
err_2 = import_err_file('../err_file/spline/base_err_vel_AB2_2.E-3_N_Ustar_TOffset_sub_tstep2.txt');
err_3 = import_err_file('../err_file/spline/base_err_vel_AB2_2.E-3_N_Ustar_TOffset_sub_tstep3.txt');
err_4 = import_err_file('../err_file/spline/base_err_vel_AB2_2.E-3_N_Ustar_TOffset_sub_tstep4.txt');
err_5 = import_err_file('../err_file/spline/base_err_vel_AB2_2.E-3_N_Ustar_TOffset_sub_tstep5.txt');
err_6 = import_err_file('../err_file/spline/base_err_vel_AB2_2.E-3_N_Ustar_TOffset_sub_tstep10.txt');
err_7 = import_err_file('../err_file/spline/base_err_vel_AB2_2.E-3_N_Ustar_TOffset_sub_tstep20.txt');
err_8 = import_err_file('../err_file/spline/base_err_vel_AB2_2.E-3_N_Ustar_TOffset_sub_tstep50.txt');
err_9 = import_err_file('../err_file/spline/base_err_vel_AB2_2.E-3_N_Ustar_TOffset_sub_tstep100.txt');
err_10 = import_err_file('../err_file/spline/base_err_vel_AB2_2.E-3_N_Ustar_TOffset_restart.txt');
...
figure(2)
loglog([sub_tstep(1) sub_tstep(end)],[max(err_10.rel_err_u(11:end)) max(err_10.rel_err_u(11:end))],'-','Color',color(1,:))
loglog([sub_tstep(1) sub_tstep(end)],[max(err_10.rel_err_v(11:end)) max(err_10.rel_err_v(11:end))],'--','Color',color(2,:))
loglog([sub_tstep(1) sub_tstep(end)],[max(err_10.rel_err_w(11:end)) max(err_10.rel_err_w(11:end))],'-.','Color',color(3,:))
loglog([sub_tstep(1) sub_tstep(end)],[max(err_10.rel_err_p(11:end)) max(err_10.rel_err_p(11:end))],':','Color',color(4,:))
hold on;
...
temp(1,:)=abs(err_u_max-max(err_10.rel_err_u(11:end)));
temp(2,:)=abs(err_v_max-max(err_10.rel_err_v(11:end)));
temp(3,:)=abs(err_w_max-max(err_10.rel_err_w(11:end)));
temp(4,:)=abs(err_p_max-max(err_10.rel_err_p(11:end)));
