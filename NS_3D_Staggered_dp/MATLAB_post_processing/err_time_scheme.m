...
err_u_max(1)=max(err_1.rel_err_p(6:end));
err_u_max(2)=max(err_2.rel_err_p(6:end));
err_u_max(3)=max(err_3.rel_err_p(6:end));
err_u_max(4)=max(err_4.rel_err_p(6:end));
err_u_max(5)=max(err_5.rel_err_p(6:end));
